...
if __name__ == "__main__":
    ...
    train_transforms, test_transforms = get_transformations(opt)
    train_set = get_train_dataset(opt, train_transforms)
    test_set = get_test_dataset(opt, test_transforms)
